...
const VortexAutogroup = () => {
  const { data: logoData } = supabase.storage.from("project").getPublicUrl("career project/VortexAuto/logo.png");
      ...
      projects={[
        {
          ...
          description:
            "Designed and launched an enterprise analytics dashboard providing real-time insights into sales, inventory, and service operations.",
          impact:
            "Improved decision-making speed by 40% across 5 departments, enabling faster response to market changes.",
          tags: ["Business Intelligence", "Data Analytics", "Dashboards"],
        },
        {
          title: "Inventory Optimization System",
          description:
            "Developed a predictive analytics model to optimize vehicle inventory levels based on historical sales data and market trends.",
        ...
        },
        {
          ...
          description:
            "Conducted in-depth customer segmentation analysis to identify high-value customer groups and tailor marketing strategies.",
        ...
        },
        {
          ...
          description:
            "Built automated reporting workflows to replace manual data compilation, saving hundreds of hours per month.",
