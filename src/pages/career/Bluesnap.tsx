...
const Bluesnap = () => {
  const { data: logoData } = supabase.storage.from("project").getPublicUrl("career project/Bluesnap/logo.png");
      ...
      projects={[
        {
          ...
          description:
            "Led the design and launch of Bluesnap's third-generation payment API, enabling faster integrations and better developer experience.",
          impact:
            "Increased transaction volume by 45% and achieved 90% API adoption among enterprise clients within 6 months.",
          tags: ["API Design", "Developer Experience", "Integration"],
        },
        {
          title: "Fraud Detection Engine",
          description:
            "Managed the development of an AI-powered fraud detection system to reduce chargebacks and improve transaction security.",
          impact:
            "Achieved 98% fraud detection accuracy, reducing chargebacks by 35% and saving merchants $2M annually.",
          tags: ["AI/ML", "Security", "Risk Management"],
        },
        {
          title: "Multi-Currency Support Expansion",
          description:
            "Expanded payment processing capabilities to support 30+ additional currencies and local payment methods.",
        ...
        },
        {
          ...
          description:
            "Redesigned the merchant-facing dashboard for better analytics, reporting, and payment reconciliation.",
